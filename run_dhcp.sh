...
echo "Starting DHCP simulations using /opt/homebrew/bin/lmp_serial"

LMP="/opt/homebrew/bin/lmp_serial"
IN_FILE="/Users/Lenovo/projects/comp2/inputs/in.dhcp.lmp"
...
shopt -s nullglob
for data in "$DATA_DIR"/dhcp_*.data; do
...
echo "🎉 All DHCP simulations finished!"
